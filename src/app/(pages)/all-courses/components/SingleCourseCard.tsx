...
import SingleCartButton from "@/app/(pages)/all-courses/components/SingleCartButton";

export default async function SingleCourseCard({course}) {
     return <div  className={styles.card}>
        ...
        <div className={styles.cardContent}>
            ...
            <SingleCartButton course={course}/>
        </div>
